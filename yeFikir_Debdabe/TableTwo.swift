...
class TableTwo: UITableViewController {
    ...
    var objects = ["የማትስ ተማሪ ደብዳቤ", "ሰዉ አይደለሁማ!","ፍልስፍና","የህግ ፍቅረኛ","አምናለሁ","ትዝ ሲለኝ","አዲስ አበቤና ኑሮ","ወደፊት!","ይገባታል!","ለምወድህና ለማፈቅርህ ብር","አጭር መልእክት","ለብቻሽ አንብቢዉ","ክትባት ዉሰጂ"," ይድረስ ለሜካኒካል ኢንጅነሯ ","ቃል እገባለሁ!","ልጅነቴ","ሞትና እሹሩሩ","ደብዳቤ 6","ምክር","ዉዴ","አቶ ገንዘብ ","ካለህበት","ፍቅር ቆሎ አይደለም","ብልጣብልጥነትና የፍቅር ፍርፋሪ","የፍቅር ፊልምና","RC1","መዋጋት ቀለለኝ","ፍቅር በድውታ","ደራሲዉ ","ህይወት ስትሟዘዝ","ዲያስፖራና የፍቅር ደብዳቤ","ቫለንታይን ዴይ"]
